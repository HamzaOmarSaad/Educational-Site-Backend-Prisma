        ...
        return [
            ...
            this.createTable({
                ...
                columns: [
                    ...
                    (0, migration_1.col)('price', 'numeric', { notNull: true, codecRef: { codecId: 'pg/numeric@1' } }),
                    (0, migration_1.col)('status', 'text', {
                        notNull: true,
                        default: (0, migration_1.lit)('DRAFT'),
                ...
                constraints: [
                    ...
                    (0, migration_1.checkExpression)('course_status_check_bc64f66b', "\"status\" IN ('DRAFT', 'PUBLISHED', 'ARCHIVED')"),
                ],
            }),
            this.createTable({
                schema: 'public',
            ...
            this.createTable({
                ...
                table: 'lesson',
                columns: [
                    (0, migration_1.col)('content', 'text', { codecRef: { codecId: 'pg/text@1' } }),
                    (0, migration_1.col)('id', 'uuid', { notNull: true, codecRef: { codecId: 'pg/uuid@1' } }),
                    (0, migration_1.col)('isFree', 'bool', {
                        notNull: true,
                        default: (0, migration_1.lit)(false),
                        codecRef: { codecId: 'pg/bool@1' },
                    }),
                    (0, migration_1.col)('order', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
                    (0, migration_1.col)('sectionId', 'uuid', { notNull: true, codecRef: { codecId: 'pg/uuid@1' } }),
                    (0, migration_1.col)('title', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
                ],
                constraints: [(0, migration_1.primaryKey)(['id'])],
            }),
            this.createTable({
                ...
                columns: [
                    (0, migration_1.col)('gradeId', 'uuid', { notNull: true, codecRef: { codecId: 'pg/uuid@1' } }),
                    (0, migration_1.col)('id', 'uuid', { notNull: true, codecRef: { codecId: 'pg/uuid@1' } }),
                    (0, migration_1.col)('school', 'text', { codecRef: { codecId: 'pg/text@1' } }),
                    (0, migration_1.col)('userId', 'uuid', { notNull: true, codecRef: { codecId: 'pg/uuid@1' } }),
                ],
                constraints: [(0, migration_1.primaryKey)(['id'])],
            }),
            this.createTable({
                ...
                columns: [
                    (0, migration_1.col)('bio', 'text', { codecRef: { codecId: 'pg/text@1' } }),
                    (0, migration_1.col)('experience', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
                    (0, migration_1.col)('id', 'uuid', { notNull: true, codecRef: { codecId: 'pg/uuid@1' } }),
                    (0, migration_1.col)('specialization', 'text', { codecRef: { codecId: 'pg/text@1' } }),
                    (0, migration_1.col)('userId', 'uuid', { notNull: true, codecRef: { codecId: 'pg/uuid@1' } }),
                ],
                constraints: [(0, migration_1.primaryKey)(['id'])],
            }),
            this.createTable({
                ...
                columns: [
                    ...
                    (0, migration_1.col)('role', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
                    (0, migration_1.col)('updatedAt', 'timestamptz', {
                        notNull: true,
                        codecRef: { codecId: 'pg/timestamptz-temporal@1' },
                    }),
                ...
                constraints: [
                    (0, migration_1.primaryKey)(['id']),
                    (0, migration_1.checkExpression)('user_role_check_1356fde6', "\"role\" IN ('STUDENT', 'TEACHER', 'ADMIN')"),
                ],
            }),
            this.addUnique({
                schema: 'public',
